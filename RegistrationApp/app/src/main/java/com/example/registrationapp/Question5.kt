...
class Question5 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_question5) // Set the activity layout
    ...
    private fun handleConfirmation() {
        ...
        if (selectedRadioButtonId == correctAnswer.id) {
            ...
            Toast.makeText(this, "This is the Correct answer, you earned $1200", Toast.LENGTH_SHORT).show()
        } else {
            Toast.makeText(this, "Wrong Answer", Toast.LENGTH_SHORT).show()
        }

        // Create an Intent to navigate to the StatsScreen activity
        ...
        startActivity(intent) // Start the StatsScreen activity
