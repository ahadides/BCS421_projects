...
class Question2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_question2) // Set the activity layout
        ...
        btnConfirm.setOnClickListener {
            ...
            if (selectedRadioButtonId == correctAnswer.id) {
                youEarnedAmount += 150 // Increase earnings for a correct answer
            ...
            // Create an Intent to navigate to the next question (Question3 activity)
